...
//    public TideData currentTideData = null; // unsupported
    ...
    private SurfSpots(SharedPreferences sp, BusyStateListener bsl) {
        ...
        addSpot("Medewi", new SurfConditionsProvider(sp, "Medewi"), new PointF(484, 460), new PointF(0, 0),
                Direction.NNE, 1, 1+2+4, 2, 7, "http://magicseaweed.com/Medewi-Surf-Report/1135/", "", -8.421528, 114.805771);
        addSpot("Balian", new SurfConditionsProvider(sp, "Balian"), new PointF(677, 568), new PointF(0, 0),
        ...
        addSpot("Canggu / Echo", new String[]{"Canggu", "Echo", "Pererenan"}, new SurfConditionsProvider(sp, "Canggu"), new PointF(840, 726), new PointF(0, 0),
                Direction.NE, 0, 1+2+4, 3, 10, "http://magicseaweed.com/Canggu-Surf-Report/935/", "http://balibelly.com/canggu", -8.654989, 115.125030);
        addSpot("Old man's / BB", new String[]{"Old mans", "Old man's", "Oldman", "Old men", "Old man", "Batu Bolong", "Batu"}, new SurfConditionsProvider(sp, "Canggu"), new PointF(843, 730), new PointF(0, 0),
        ...
        addSpot("Berawa", new String[]{"Brava"}, new SurfConditionsProvider(sp, "Canggu"), new PointF(845, 734), new PointF(0, 0),
        ...
        addSpot("Padma", new SurfConditionsProvider(sp, "Padma"), new PointF(867, 758), new PointF(0, 0),
                Direction.NE, 0, -1, -1, -1, "http://magicseaweed.com/Padma-Surf-Report/4005/", "", -8.705259, 115.165101);
        addSpot("Seminyak", new SurfConditionsProvider(sp, "Halfway"), new PointF(887, 784), new PointF(0, 0),
        ...
        addSpot("Kuta Beach", new String[]{"Kuta"}, new SurfConditionsProvider(sp, "Kuta-Beach"), new PointF(887, 798), new PointF(0, 0),
        ...
        addSpot("Airport left's", new String[]{"Airport", "Airport left"}, new SurfConditionsProvider(sp, "Airport-Lefts"), new PointF(874, 836), new PointF(0, 0),
                Direction.E, 1, 2+4, 4, 6, "http://magicseaweed.com/Airport-Reef-Surf-Report/2309/", "", -8.740112, 115.150799);
        addSpot("Airport right", new String[]{"Airport right's"}, new SurfConditionsProvider(sp, "Airport-Rights_2"), new PointF(878, 849), new PointF(0, 0),
        ...
        addSpot("Balangan", new SurfConditionsProvider(sp, "Balangan"), new PointF(840, 894), new PointF(0, 0),
                Direction.SE, 1, 1+2+4, 4, 8, "http://magicseaweed.com/Balangan-Surf-Report/2304/", "", -8.792450, 115.120989);
        addSpot("Dreamland", new String[]{"Dream Land"}, new SurfConditionsProvider(sp, "Dreamland"), new PointF(830, 901), new PointF(0, 0),
                Direction.SE, 0, 1+2, 2, 8, "http://magicseaweed.com/Dreamland-Surf-Report/2301/", "", -8.799007, 115.116690);
        addSpot("Bingin", new SurfConditionsProvider(sp, "Bingin"), new PointF(822, 908), new PointF(0, 0),
                Direction.SE, 1, 2, 3, 7, "http://magicseaweed.com/Bingin-Surf-Report/878/", "http://balibelly.com/bingin", -8.805410, 115.111312);
        addSpot("Impossibles", new SurfConditionsProvider(sp, "Bingin"), new PointF(818, 913), new PointF(0, 0),
                Direction.SE, 1, 1+2+4, 4, 8, "http://magicseaweed.com/Impossibles-Surf-Report/2302/", "", -8.808615, 115.104613);
        addSpot("Padang-Padang", new String[]{"Padang Padang", "Padang"}, new SurfConditionsProvider(sp, "Bingin"), new PointF(809, 917), new PointF(0, 0),
                Direction.SE, 1, 2+4, 6, 8, "http://magicseaweed.com/Padang-Padang-Surf-Report/1121/", "", -8.809937, 115.100767);
        addSpot("Uluwatu", new SurfConditionsProvider(sp, "Uluwatu"), new PointF(795, 922), new PointF(0, 0),
                Direction.SE, 1, 1+2+4, 2, 9, "http://magicseaweed.com/Uluwatu-Surf-Report/565/", "http://balibelly.com/uluwatu", -8.815899, 115.086159);
        addSpot("Nyang-Nyang", new String[]{"Nyang Nyang", "Nyang"}, new SurfConditionsProvider(sp, "Uluwatu"), new PointF(802, 952), new PointF(0, 0),
        ...
        addSpot("Green Ball", new String[]{"Green bowl"}, new SurfConditionsProvider(sp, "Green-Ball"), new PointF(898, 962), new PointF(0, 0),
                Direction.N, -1, 2, 2, 7, "http://magicseaweed.com/Green-Ball-Surf-Report/2320/", "", -8.849996, 115.171464);
        addSpot("Nusa Dua", new SurfConditionsProvider(sp, "Nusadua"), new PointF(981, 911), new PointF(0, 0),
                Direction.NW, 0, 1+2+4, 3, 9, "http://magicseaweed.com/Nusa-Dua-Surf-Report/564/", "", -8.818622, 115.231821);
        addSpot("Sri Lanka", new String[]{"lanka"}, new SurfConditionsProvider(sp, "Sri-Lanka"), new PointF(965, 881), new PointF(0, 0),
                Direction.SW, -1, 1+2, 4, 8, "http://magicseaweed.com/Sri-Lanka-Surf-Report/2312/", "", -8.788045, 115.233243);

        categories.put(list.size(), "Sanur");
        addSpot("Serangan", new SurfConditionsProvider(sp, "Sanur-Reef"), new PointF(985, 828), new PointF(0, 0),
        ...
        addSpot("Tandjung left's", new String[]{"Tandjung", "Tanjung"}, new SurfConditionsProvider(sp, "Tandjung-Lefts"), new PointF(1014, 769), new PointF(0, 0),
                Direction.NW, 1, 1+2+4, 3, 8, "http://magicseaweed.com/Tanjung-Sari-Surf-Report/2313/", "", -8.698470, 115.270707);
        addSpot("Tandjung right's", new SurfConditionsProvider(sp, "Tandjung-Rights"), new PointF(1014, 769), new PointF(0, 0),
                Direction.NW, -1, 1+2+4, 3, 8, "http://magicseaweed.com/Tanjung-Sari-Surf-Report/2313/", "", -8.691786, 115.270863);
        addSpot("Sanur Reef", new String[]{"Sanur"}, new SurfConditionsProvider(sp, "Sanur-Reef"), new PointF(1009, 749), new PointF(0, 0),
...
//        addSpot("Lebih", new SurfConditionsProvider(sp, "Ketewel"), new PointF(1150, 637), new PointF(0, 0), Direction.W);
        addSpot("Keramas", new SurfConditionsProvider(sp, "Keramas-Beach"), new PointF(1116, 650), new PointF(0, 0),
                Direction.NW, -1, 1+2+4, 2, 9, "http://magicseaweed.com/Keramas-Surf-Report/909/", "http://balibelly.com/keramas", -8.587816, 115.351592);
        addSpot("Padangbai", new String[]{"Padang Bay"}, new SurfConditionsProvider(sp, "Padangbai"), new PointF(1306, 585), new PointF(0, 0),
        ...
        addSpot("Shipwrecks", new String[]{"Ship Wrecks"}, new SurfConditionsProvider(sp, "Shipwrecks"), new PointF(1245, 735), new PointF(0, 0),
                Direction.E, -1, 2+4, 3, 8, "http://magicseaweed.com/Shipwrecks-Lembongan-Surf-Report/1088/", "", -8.664195, 115.442830);
        addSpot("Lacerations", new SurfConditionsProvider(sp, "Lacerations"), new PointF(1234, 735), new PointF(0, 0),
                Direction.E, -1, 2+4, 3, 8, "http://magicseaweed.com/Lacerations-Surf-Report/1090/", "", -8.671239, 115.441876);
        addSpot("Playgrounds", new String[]{"Playground"}, new SurfConditionsProvider(sp, "Playgrounds"), new PointF(1227, 746), new PointF(0, 0),
                Direction.E, 0, 1+2+4, 2, 7, "http://magicseaweed.com/Playgrounds-Surf-Report/1089/", "", -8.675822, 115.440853);
        addSpot("Ceningan", new SurfConditionsProvider(sp, "Ceningan-Point"), new PointF(1216, 786), new PointF(0, 0),
...
//    }
    private void addSpot(String name, SurfConditionsProvider conditionsProvider, PointF pointOnSVG, PointF pointEarth, Direction waveDirection, int leftright, int tides, int minSwell, int maxSwell, String msw, String urlCam, double la, double lo) {
    ...
    private void addSpot(String name, String[] alt, SurfConditionsProvider conditionsProvider, PointF pointOnSVG, PointF pointEarth, Direction waveDirection, int leftright, int tides, int minSwell, int maxSwell, String msw, String urlCam, double la, double lo) {
